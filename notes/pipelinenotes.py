...
model 1 (extract entities from a document) - spacy 
model 2 (extract aspects of entities from a document) - spacy?
model 3 (sentiment/subjectivity analysis) - bert 
"""

"""
Opinion quintuple
Entity, aspect, sentiment (towards aspects), opinion holder, time (of opinion)
"""